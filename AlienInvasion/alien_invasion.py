...
class AlienInvasion:
	...
	def _check_bullet_alien_collisions(self):
		"""Check for bullets that have hit aliens, and remove both bullet and alien"""
	...
	def _update_aliens(self):
		...
		# Look for aliens hitting the botttom of the screen.
	...
	def _create_alien(self, alien_number, row_number):
		...
		alien.rect.y = alien_height + 4 * alien.rect.height * row_number
	...
	def _change_fleet_direction(self):
		"""Frop the entire fleet and change direction."""
		for alien in self.aliens.sprites():
